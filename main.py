...
bg_image = pygame.image.load("assets/images/background/b.png").convert_alpha()
...
while run:
  ...
  draw_text("Attack Keys: R T", score_font, WHITE, 20, 100)
  draw_text("P2: " + str(score[1]), score_font, RED, 580, 60)
  draw_text("Attack Keys: 1 2", score_font, WHITE, 580, 100)
